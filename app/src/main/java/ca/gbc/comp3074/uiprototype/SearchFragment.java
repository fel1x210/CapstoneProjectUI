...
public class SearchFragment extends Fragment {
    ...
    private final List<Place> places = Arrays.asList(
            new Place("The Urban Reader Café", "Café", "0.2 miles", 4.7f, 362,
                    Arrays.asList("Quiet corners", "WiFi", "Specialty brews")),
            new Place("Central Library", "Library", "0.5 miles", 4.5f, 128,
                    Arrays.asList("Study rooms", "Very quiet", "Research help")),
            new Place("Peaceful Corner Coworking", "Coworking", "0.8 miles", 4.8f, 89,
                    Arrays.asList("Professional", "Outlets", "Meeting rooms")),
            new Place("Sunset Study Lounge", "Lounge", "1.2 miles", 4.6f, 54,
                    Arrays.asList("Sunset view", "Quiet", "Snacks")),
            new Place("Aurora Reading Atrium", "Library", "1.5 miles", 4.9f, 204,
                    Arrays.asList("Natural light", "Quiet zones", "Coffee bar")),
            new Place("Focus Hub Midtown", "Coworking", "2.0 miles", 4.4f, 178,
                    Arrays.asList("24/7 access", "Phone booths", "Events")),
            new Place("Greenhouse Courtyard", "Garden", "2.3 miles", 4.3f, 96,
